...
%\chapter[Introduction]{\en{Introduction}\zhcn{引言}}
%\chapter*{\en{Introduction}\zhcn{引言}}

\section[The Religion of Good-citizenship]
{\en{The Religion of Good-citizenship}\zhcn{好公民的宗教}}
...
\footnote{
\en{Aren't we just doing the right thing?}\zhcn{难道我们这样做有什么不对吗？}\en{the mob we must befool them;}\zhcn{群氓，我们不能不愚弄他们；} \\
\en{See, now, how shiftless!}\zhcn{你瞧，他们多么懒惰无能！}\en{and look now how wild!}\zhcn{看上去多么野蛮！}\en{for such is the mob.}\zhcn{} \\
